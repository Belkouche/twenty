...
// Opening the popover reads pointer data from the missing nativeEvent.
...
// Menu opening reads nativeEvent.pointerType and pointer data from the
// missing nativeEvent.
...
// Select opening reads nativeEvent.pointerType and pointer data from the
// missing nativeEvent.
...
// Opening the alert dialog reads pointer data from the missing nativeEvent.
