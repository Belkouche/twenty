...
export const AiChatSharingDropdown = ({
  ...
  return (
    <RecordSharingDropdown
      ...
      description={t`Viewers can read this conversation and future messages. Editors can also send messages and change sharing. AI actions use the sender’s own permissions.`}
      recordUrl={
        new URL(
